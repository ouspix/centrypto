...
export const AGENT_PRESETS: Record<string, AgentConfig> = {
    ...
    "Momentum Moderate": preset({
        ...
        triggers: {
            ...
            mean_reversion: { ret_sigma_threshold: 3.0, book_pressure_min: 0.15, chop_regime: "required" },
    ...
    "Swing Relaxed": preset({
        ...
        risk: {
            ...
            max_effective_leverage: 4,
            exchange_max_leverage_allowed: 4,
            max_correlation_group_exposure_fraction: 0.75,
            margin_mode: "isolated",
            slippage_pct: 0.008
        },
        triggers: {
    ...
    "Testnet Aggressive": preset({
        ...
        cost_sanity: {
            min_edge_to_cost_mult: 1.5,
            min_stop_to_cost_mult: 1.0,
            min_tp_to_cost_mult: 1.2
        },
        correlation: {
