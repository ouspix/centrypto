...
export class SnapshotBuilder {
    ...
    private regimeServices: Record<string, RegimeService>;
    private regimeUniverseService: RegimeUniverseService;
    ...
    constructor() {
        ...
        this.regimeServices = {};
        this.regimeUniverseService = new RegimeUniverseService(this.marketAnalysisService);
    ...
    private getRegimeService(isTestnet: boolean) {
        const key = isTestnet ? "testnet" : "mainnet";
        if (!this.regimeServices[key]) {
            this.regimeServices[key] = new RegimeService();
        }
        return this.regimeServices[key];
    }
    ...
    public async buildSnapshot(
        ...
        return {
            ...
            meta: {
                ...
                regime_markets: Object.keys(regimeMarkets)
            },
            presets: {
